## Implementation
- [x] Capture behavioral RED for eligible sibling overload retry.
- [x] Capture behavioral RED for soft-owner reroute during early backoff.
- [x] Implement retained replacement admission without weakening continuity.
- [x] Extend soft reroute to active backoff with existing eligibility checks.
## Verification
